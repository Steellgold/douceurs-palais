 ...
 */
final class Version20250424140333 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE `order` (id VARCHAR(36) NOT NULL, user_id VARCHAR(36) NOT NULL, bakery_id VARCHAR(36) DEFAULT NULL, reference VARCHAR(255) NOT NULL, total_amount DOUBLE PRECISION NOT NULL, status VARCHAR(50) NOT NULL, stripe_session_id VARCHAR(255) DEFAULT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', shipping_address JSON DEFAULT NULL, billing_address JSON DEFAULT NULL, INDEX IDX_F5299398A76ED395 (user_id), INDEX IDX_F52993985570DBC4 (bakery_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE `order` ADD CONSTRAINT FK_F52993985570DBC4 FOREIGN KEY (bakery_id) REFERENCES bakery (id)
        SQL);
        $this->addSql(<<<'SQL'
